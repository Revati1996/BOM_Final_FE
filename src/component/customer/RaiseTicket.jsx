...
const RaiseTicket = () => {
  ...
  const loadUsers = async () => {
    const result = await axios.get("/customer-api/customer/"+ localStorage.getItem("custId") +"/10/0");
  ...
  const onSubmit = async e => {
    e.preventDefault();
    await axios.post("/customer-api/customer/ticket", customerConcernObj).then(res => {
