...
import ApplyForLoan from "../loan-service/apply-for-loan/ApplyForLoan";
import GetAllLoan from "../loan-service/get-all-loans/GetAllLoans";
import ModifyLoanAmount from "../loan-service/modify-loan-amount/ModifyLoanAmount";
import GetLoanForCidLid from "../loan-service/get-loan-for-cidlid/GetLoanForCidLid";
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavDropdown title="Loan Service" id="collasible-nav-dropdown">
                <NavDropdown.Item ><Link to={`${match.path}/applyForLoan`}>Apply for loan</Link></NavDropdown.Item>
                <NavDropdown.Item ><Link to={`${match.path}/loans`}>All loans</Link></NavDropdown.Item>
                <NavDropdown.Item ><Link to={`${match.path}/modifyLoan`}>Modify loan amount</Link></NavDropdown.Item>
              </NavDropdown>
            </Nav>
            <Nav>
        ...
        <main role="main">
          <div className="main">
            <Switch>
              ...
              <Route path={`${match.path}/applyForLoan`}>
              ...
              <Route path={`${match.path}/modifyLoan`}>

                <ModifyLoanAmount />

              </Route>

              <Route path={`${match.path}/getLoanForCidLid`}>
